...
C     YOU WILL HAVE TO REPLACE THIS PROGRAM AND THE SUBROUTINE 
C     FETCHPLANE IN THIS FILE WITH YOUR OWN. THESE ARE JUST EXAMPLES.
C
C     SRB - LENGTH OF CEDRIC HEADER RECORD ALWAYS = 510
...
C     SRB - TEMPORARY; NEED TO PROMPT FOR THESE
c      OLAT = 25.4800014 
c      OLON = -87.4400024
...
c     READ(5,'(A56)')NAME
      ...
      read(99)date,suffixAB,ih,ix0,iy0,iz0,imax,jmax,kmax,isx,isy,isz
     +     ,et1,et2,et3,ep1,ep2,ep3,v0,pm0,pm1,pm2
      print *,'PT FILE HEADER:'
      print *,'  start time        = ',ih(1),ih(2),ih(3)
      print *,'  end time          = ',ih(4),ih(5),ih(6)
      print *,'  xdim/ydim/zdim    = ',imax,jmax,kmax
      print *,'  xres/yres/zres(m) = ',isx,isy,isz
c     print *,   date,suffixAB,ih,ix0,iy0,iz0,imax,jmax,kmax,isx,isy,isz
c     +     ,et1,et2,et3,ep1,ep2,ep3,v0,pm0,pm1,pm2
...
c     CALL WRITEIDATA(IDATA,IMAX,JMAX,KMAX)
      ...
      READ(5,'(A4)')PROJECT
      WRITE(6,*)'ENTER CENTER LATITUDE'
      READ(5,*)OLAT
      WRITE(6,*)'ENTER CENTER LONGITUDE'
      READ(5,*)OLON
      TAPE    = '000000'
      RADCON  = -99.9
      VNYQ    = -99.9
...
C     SRB - OLAT AND OLON ARE NEVER INTIALISED
      LATDEG = INT(OLAT)
      REMLAT = OLAT-LATDEG
...
c                    CALL COMP(XU,XV,WDR,WSP)
               ...
               ELSE
                  DBZ(I,J,K)=FLAG
               ENDIF
c              WRITE(6,*)'I,J,K,U,V,W,DBZ,DIV = ',I,J,K,U(I,J,K),
c    1              V(I,J,K),W(I,J,K),DBZ(I,J,K),DIV(I,J,K)
 3          CONTINUE
 2       CONTINUE
 1    CONTINUE 
      RETURN
